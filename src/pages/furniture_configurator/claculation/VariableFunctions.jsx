...
function VariableFunctions({ MaterialCalculationList, setMaterialCalculationList, totalReset }) { // VeriableList,
    ...
    const CreateCalculationMaterial = async () => {
        const { data } = await CreateCalculation(MaterialCalculationList, "addDataToVariable", TestTottal)
        if (data) {
