...
function GeneralFunctions({ MaterialCalculationList, setMaterialCalculationList, totalReset }) { // VeriableList,
    ...
    const CreateCalculationMaterial = async () => {
        const { data } = await CreateCalculation(MaterialCalculationList, "addDataToGeneralVariable", TestTottal)
        if (data) {
