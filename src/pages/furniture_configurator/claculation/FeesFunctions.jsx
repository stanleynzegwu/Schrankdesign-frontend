...
function FeesFunctions({ MaterialCalculationList, setMaterialCalculationList, totalReset }) { // VeriableList,
    ...
    const CreateCalculationMaterial = async () => {
        const { data } = await CreateCalculation(MaterialCalculationList, "addDataToFeesVariable", TestTottal)
        if (data) {
