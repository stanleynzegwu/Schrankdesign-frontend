...
import { HandlesAccordianAfter, HandlesAccordianBefore } from "../../../components/furniture-configurator/FittingAccordian"
...
const Others = () => {
    ...
    useEffect(() => {
        const GetDrawer = async () => {
            const { data, error } = await GetallDrawer("getfitting")
            if (data) {
