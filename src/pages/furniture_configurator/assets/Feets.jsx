...
import { HandlesAccordianAfter, HandlesAccordianBefore } from "../../../components/furniture-configurator/FeetAccordian"
        ...
        <Layout>
            <SubLayout tabs={tabs}>
                ...
                {(Feetslist?.length > 0 && Array.isArray(Feetslist)) &&
                    Feetslist.map((item, index) => <Accordian onClose={fetchUpdatedPartList} afterCollapse={<HandlesAccordianAfter drawerlistUpdate={setFeetlist} viewdata={item} />} beforeCollapse={<HandlesAccordianBefore viewdata={item} />} setState={setNewDrawer} />)
                }
            </SubLayout>
        </Layout>
    )
