...
import {
  DrawerAccordianAfter,
  DrawerAccordianBefore,
} from "../../../components/furniture-configurator/DrawerAccordian";
    ...
    <Layout>
      <SubLayout tabs={tabs}>
        ...
        {NewDrawer && (
          <Accordian
            afterCollapse={
              <DrawerAccordianAfter drawerlistUpdate={setDrawerList} createDrawer={true} />
            }
            add={true}
        ...
        {DrawerList?.length > 0 &&
          ...
          DrawerList.map((item, index) => (
            <Accordian
              afterCollapse={
                <DrawerAccordianAfter drawerlistUpdate={setDrawerList} viewdata={item} />
              }
              beforeCollapse={<DrawerAccordianBefore viewdata={item} />}
              setState={setNewDrawer}
            />
          ))}
      </SubLayout>
