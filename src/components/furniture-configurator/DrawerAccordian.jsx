        ...
        <Form className="w-full pb-4">
          <div className="flex relative justify-between flex-wrap p-5 pr-16">
            ...
            <div className="flex flex-col items-center justify-between h-full">
                ...
                <div className="w-[170px]">
                  <div className="relative">
                    <Field
                      ...
                      name={"name"}
                    />
                    <ErrorMessage name={"name"} component="div" className="mt-2 text-red-500" />
                  </div>
                </div>
              </div>
              <div className="flex flex-row mb-2  justify-between w-full gap-[25px]">
                <h1 className="font-[karla] text-[20px] font-semibold">Config ID</h1>
                <div className="w-[170px]">
                  <div className="relative">
                    <Field
                      className="block text-[20px] leading-[30px] font-[karla] font-bold  outline-none w-full border border-solid border-black bg-[#F6F6F6] rounded-[3px] px-4"
                      ...
                      disabled
                    />
                    <ErrorMessage name={"configId"} component="div" className="mt-2 text-red-500" />
                  </div>
                </div>
              </div>
              <div className="flex flex-row mb-2  justify-between w-full gap-[25px]">
                <h1 className="font-[karla] text-[20px] font-semibold">Supplier ID</h1>
                <div className="w-[170px]">
                  <div className="relative">
                    <Field
                      className="block text-[20px] leading-[30px] font-[karla] font-bold  outline-none w-full border border-solid border-black bg-[#F6F6F6] rounded-[3px] px-4"
              ...
              <div className="flex flex-row mb-2  justify-between w-full gap-[25px]">
                <h1 className="font-[karla] text-[20px] font-semibold">Construction Time</h1>
                <div className="w-[170px]">
                  <div className="relative">
                    <Field
                    ...
                    <div className="pointer-events-none absolute inset-y-0 right-0 flex  pr-3">
                      <p className="text-[18px] leading-[30px] font-[karla] font-normal">min</p>
                    </div>
                    <ErrorMessage
                      name={"con_asset_time_pcs"}
                      component="div"
              ...
              {/* <div className="flex flex-row mb-2  justify-between w-full gap-[25px]">
                <h1 className="font-[karla] text-[20px] font-semibold">Plate-Material-ID</h1>
                <div className="w-[170px]">
                  <div className="relative">
                    <Field
                      className="block text-[20px] leading-[30px] font-[karla] font-bold  outline-none w-full border border-solid border-black bg-[#F6F6F6] rounded-[3px] pl-3 pr-14"
            ...
            <div className="flex flex-col items-center justify-between h-full">
              <div className="flex flex-row mb-2  justify-between w-full gap-[25px]">
                <h1 className="font-[karla] text-[20px] font-semibold">Price Einkauf </h1>
                <div className="w-[170px]">
                  <div className="relative">
                    <Field
                      className="block text-[20px] leading-[30px] font-[karla] font-bold  outline-none w-full border border-solid border-black bg-[#F6F6F6] rounded-[3px] pl-3 pr-14"
                    ...
                    />
                    <div className="pointer-events-none absolute inset-y-0 right-0 flex  pr-3">
                      <p className="text-[18px] leading-[30px] font-[karla] font-normal">€/pcs</p>
                    </div>
                    <ErrorMessage
                      name={"price_einkauf"}
                      component="div"
              ...
              <div className="flex flex-row  mb-2  justify-between w-full gap-[25px]">
                <h1 className="font-[karla] text-[20px] font-semibold">Price-Profit</h1>
                <div className="w-[170px]">
                  <div className="relative">
                    <Field
                      className="block text-[20px] leading-[30px] font-[karla] font-bold  outline-none w-full border border-solid border-black bg-[#F6F6F6] rounded-[3px] pl-3 pr-14"
                    ...
                    />
                    <div className="pointer-events-none absolute inset-y-0 right-0 flex  pr-3">
                      <p className="text-[18px] leading-[30px] font-[karla] font-normal">%</p>
                    </div>
                    <ErrorMessage
                      name={"price_aufschlag"}
                      component="div"
              ...
              <div className="flex flex-row mb-2  justify-between w-full gap-[25px]">
                <h1 className="font-[karla] text-[20px] font-semibold">Packing Time</h1>
                <div className="w-[170px]">
                  <div className="relative">
                    <Field
                      className="block text-[20px] leading-[30px] font-[karla] font-bold  outline-none w-full border border-solid border-black bg-[#F6F6F6] rounded-[3px] pl-3 pr-14"
              ...
              <div className="flex flex-row mb-2  justify-between w-full gap-[25px]">
                <h1 className="font-[karla] text-[20px] font-semibold">Belastung</h1>
                <div className="w-[170px]">
                  <div className="relative">
                    <Field
                      className="block text-[20px] leading-[30px] font-[karla] font-bold  outline-none w-full border border-solid border-black bg-[#F6F6F6] rounded-[3px] pl-3 pr-14"
                    ...
                    />
                    <div className="pointer-events-none absolute inset-y-0 right-0 flex  pr-3">
                      <p className="text-[18px] leading-[30px] font-[karla] font-normal">kg</p>
                    </div>
                    <ErrorMessage name={"weight"} component="div" className="mt-2 text-red-500" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="flex flex-col gap-[10px]">
                <div className="flex flex-col gap-[5px]">
                  <div className="flex flex-row justify-between gap-6">
                    ...
                    <h1 className="font-[karla] leading-[16px] font-semibold text-[18px]">
                      {(() => {
                        const price_einkauf = +formik?.values?.price_einkauf || 0;
                        const price_aufschlag = +formik?.values?.price_aufschlag || 0;
                        const totalSalePrice = parseFloat(
                          (price_einkauf + (price_einkauf * price_aufschlag) / 100).toFixed(2)
                        );
          ...
          <div className="flex pr-16">
            <div className="flex items-center justify-between h-full m-auto">
              ...
              <div className=" rounded-[5px]">
                <Field
                  component="textarea"
                  className="outline-none w-[32.5rem] border border-black rounded-[5px] h-[100px]"
                  name="description"
                ></Field>
