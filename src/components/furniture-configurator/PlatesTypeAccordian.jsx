...
export const PlatesTypeAccordianBefore = ({ handleToggle, index, viewdata }) => {
  const HandleEdit = (id) => {
      ...
      <div className="relative gap-[15px] flex">
        ...
        <span className="block text-[20px] leading-[30px] font-[karla] font-bold  outline-none w-full border border-solid border-black bg-[#F6F6F6] rounded-[3px] px-3">
          <div className="flex items-center gap-4">
            {dropdownOptionsEdge.filter((item) => item.label === viewdata?.edge_0)[0]?.icon}
            {viewdata?.edge_0}
          </div>
        </span>
      </div>
...
const dropdownOptionsEdge = [
  ...
  {
    label: "VHR",
    icon: <div className="w-6 h-6 border-gray-600 border-t-4 border-r-4 border-y-4"></div>,
  },
  {
    label: "VHL",
    icon: <div className="w-6 h-6 border-gray-600 border-t-4 border-l-4 border-y-4"></div>,
  },
  {
    label: "VLR",
    icon: <div className="w-6 h-6 border-gray-600  border-r-4 border-l-4 border-b-4"></div>,
  },
  {
    label: "HLR",
    icon: (
...
export const PlatesTypeAccordianAfter = ({
  ...
  return (
    <Formik initialValues={platesTypesinitialValues} onSubmit={Handlesubmit} enableReinitialize>
      {(formik) => (
          ...
          <div className="flex justify-between max-w-7xl flex-wrap py-5 pl-5 pr-16">
                    ...
                    >
                      ...
                      <div className="w-[170px]">
                        <Select
                          ...
                          onChange={(value) => handleEdgeSelect(value, formik, `edge_${index}`)}
            ...
            <div className="flex flex-col items-center gap-[15px]">
              <div className="flex flex-row justify-between w-full gap-[15px]">
                <h1 className="font-[karla] text-[20px]">CNC Time</h1>
                <div className="w-[170px]">
                  <div className="relative">
                    <Field
