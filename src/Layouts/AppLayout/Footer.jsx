...
const serviceData = [
  ...
  {
    id: 4,
    link: "/service/lieferung%20&%20Montage",
    title: "Maßanfertigung & Sonderwunsch",
  },
  {
    id: 5,
    link: "/service/bestellung%20&%20Konfiguration",
    title: "Bestellung & Konfiguration",
  },
];
...
const Footer = () => {
  return (
    <>
      <div className="pt-[72px] pb-12 bg-[#676767]">
        <div className="max-w-[95%] mx-auto text-white p-4">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-40 justify-between">
            {/* 1st */}
            <div className="max-w-[325px] break-words">
              <p className="mb-5 font-semibold uppercase">Unser Service</p>
              <ul className="">
                {serviceData &&
                  serviceData.map((item, index) => (
                    <li key={index} className="mb-3 hover:opacity-70 transition-all">
            ...
            {/* 2nd */}
            <div className="">
              <p className="mb-5 font-semibold uppercase">Rechtliches</p>

              <div className="">
                <ul>
                  <li className="mb-3 hover:opacity-70 transition-all">
                    <Link href="#">AGB</Link>
                  </li>
                  <li className="mb-3 hover:opacity-70 transition-all">
                    <Link href="#">Widerrufsrecht</Link>
                  </li>
                  <li className="mb-3 hover:opacity-70 transition-all">
                    <Link href="#">Impressum</Link>
                  </li>
                  <li className="mb-3 hover:opacity-70 transition-all">
                    <Link href="#">Versand</Link>
                  </li>
                  <li className="mb-3 hover:opacity-70 transition-all">
            ...
            {/* 3rd */}
            <div className="">
              <p className="mb-5 font-semibold">Designermöbel nach Maß</p>
              <div className="">
          ...
          {/* -------------------------------------------- */}
          <div className="mt-10">
            <span className="flex items-center">Schrankdesign.de </span>
            <div className="mt-4 ml-auto md:flex w-auto md:w-max">
              <span className="text-sm text-[#D2D2C1]">Wir akzeptieren</span>

              <div className="flex flex-wrap gap-2 md:ml-4 mt-4 md:mt-0">
                <svg
